...
//    private static final String USER_SERVER_URL = "http://192.168.11.36/api.php/";
    ...
    public interface GoodsApi {
        ...
        @FormUrlEncoded
        @POST("/goods/goods_list2")
        Observable<SubCategory> goods_list2(@FieldMap Map<String, String> params);
        ...
        @FormUrlEncoded
        @POST("/goods/goods_list_vv2")
        Observable<List<Goods>> goods_list_vv2(@FieldMap Map<String, String> params);
        ...
        @FormUrlEncoded
        @POST("/goods/vip_goods_list2")
        Observable<SubCategory> vip_goods_list2(@FieldMap Map<String, String> params);
    ...
    public static HashMap<String, String> gen_goods_list2_params(String token, String cat_id, String sort, int page, String keyword) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("token", token);
        hashMap.put("cat_id", cat_id);
        hashMap.put("sort", sort);
