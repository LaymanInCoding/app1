...
import com.xiaomabao.weidian.listeners.SwipeRefreshListener;
...
public class SwipeRefreshLayout extends ViewGroup {
	 ...
	 * gesture.
	 */
	public void setOnRefreshListener(SwipeRefreshListener listener) {
		mListener = listener;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			final float yDiff = (y - mInitialMotionY) / 3;
